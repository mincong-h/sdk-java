 ...
 * machine as if it were a local object, making it easier for you to create distributed
 * applications and services. As in many RPC systems, gRPC is based around the idea of defining a
 * service, specifying the methods that can be called remotely with their parameters and return
 * types.
 *   - On the server side, the server implements this interface and runs a gRPC server to handle
 *     client calls.
 ...
 *
 * See https://www.grpc.io/docs/what-is-grpc/introduction/#overview
 */
